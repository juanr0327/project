...
const description = (
  <DescriptionList className={styles.headerList} size="small" col="2">
    ...
    <Description term="创建时间">2019-04-17 10:38:53</Description>
    <Description term="关联任务号">
      <a href="">1</a>
    </Description>
    <Description term="完成日期">2019-04-17 11:38:53</Description>
      ...
      >
        ...
        <Card title="银行卡信息" style={{ marginBottom: 24 }} bordered={false}>
          <DescriptionList style={{ marginBottom: 24 }}>
            <Description term="姓名">付小小</Description>
            <Description term="卡号">32943898021309809423</Description>
          ...
          <Card type="inner" title="多层级信息组">
            <DescriptionList size="small" style={{ marginBottom: 16 }} title="组名称">
              <Description term="负责人">曲丽丽</Description>
              <Description term="角色码">0</Description>
              <Description term="所属部门">XX公司 - YY部</Description>
              <Description term="入职时间">2017-08-08</Description>
              <Description term="描述">
                ...
              </Description>
            </DescriptionList>
